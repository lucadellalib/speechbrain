...
def fine_tune_whisper(
    ...
    training_kwargs.setdefault("per_device_train_batch_size", 4)
    training_kwargs.setdefault("gradient_accumulation_steps", 1)
    ...
    training_kwargs.setdefault("dataloader_num_workers", 2)
    ...
    training_kwargs.setdefault("per_device_eval_batch_size", 4)
    training_kwargs.setdefault("predict_with_generate", True)
    training_kwargs.setdefault("generation_max_length", 200)
