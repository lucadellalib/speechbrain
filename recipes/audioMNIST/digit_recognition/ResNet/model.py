...
# Adapted from:
# https://github.com/pytorch/vision/blob/v0.13.1/torchvision/models/resnet.py
...
class ResNet(nn.Module):
    ...
    block : type
        The block type. Default to `BasicBlock`.
    in_channels : int
        The number of input channels.
    num_classes : int
        The number of output classes.
    norm_layer : type
        The normalization layer type. Default to `nn.BatchNorm2d`.
