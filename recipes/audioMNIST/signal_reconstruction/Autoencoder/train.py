...
"""Recipe for training a signal reconstruction system on audioMNIST
...
class SignalReconstructionBrain(sb.Brain):
    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        loss = sb.nnet.losses.mse_loss(predictions, label, lens)
...
if __name__ == "__main__":
    ...
    digit_recognition_brain = SignalReconstructionBrain(
