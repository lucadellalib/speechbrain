#!/usr/bin/env/python3
"""Recipe for training an S4 separation system on the wsjmix dataset.
...
class Separation(sb.Brain):
    def compute_forward(self, mix, targets, stage, noise=None):
        ...
        est_mask = self.hparams.MaskNet(mix_w.movedim(-1, -2)).movedim(-1, -2)
        B, C, L = est_mask.shape
        est_mask = F.relu(est_mask.reshape(self.hparams.num_spks, B, -1, L))
    ...
    def init_optimizers(self):
        ...
        all_parameters = list(self.modules.parameters())
        ...
        # Add S4 parameters with special hyperparameters
