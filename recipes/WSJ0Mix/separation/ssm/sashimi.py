...
# Adapted from:
# https://github.com/HazyResearch/state-spaces/blob/d589d982216485cce0a46bbe7605fe75c03d3223//sashimi/sashimi.py
...
__all__ = ["DownPool", "FFBlock", "ResidualBlock", "Sashimi", "UpPool"]
...
class DownPool(nn.Module):
    def __init__(self, d_input, expand, pool):
        ...
        self.linear = LinearActivation(
            d_input * pool, self.d_output, transposed=True,
        )
...
class UpPool(nn.Module):
    def __init__(self, d_input, expand, pool):
        ...
        self.linear = LinearActivation(
            d_input, self.d_output * pool, transposed=True,
        )
...
class ResidualBlock(nn.Module):
    def __init__(
        self, d_model, layer, dropout=0.0,
    ):
        """
        Residual S4 block.
        Args:
