#!/usr/bin/env python3
"""Recipe for training a Bayesian phoneme recognizer on TIMIT via Bayes by Backprop (https://arxiv.org/abs/1505.05424).
...
if __name__ == "__main__":
    ...
    for key in ["ctc_lin", "seq_lin"]:
        ...
        hparams[key] = hparams["modules"][key] = BayesByBackpropModule(
            hparams["modules"][key],
            prior_builder,
            prior_kwargs,
            posterior_builder,
